    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header modal-colored-header bg-danger">
                <h4 class="modal-title" id="danger-header-modalLabel">Xóa Nhà Xuất Bản
                </h4>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    deleteModal.addEventListener('show.bs.modal', function(event) {
        ...
        var nhaXuatBanId = button.getAttribute('data-id');

        // Cập nhật action của form để bao gồm prefix '/public/admin/the-loai/xoa-the-loai'
        var form = document.getElementById('delete-form');
        form.action =
            `/public/admin/nha-xuat-ban/xoa-nha-xuat-ban/${nhaXuatBanId}`;
    });
});
</script>